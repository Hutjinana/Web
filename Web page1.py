    ...
    with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
        while camera.isOpened():
            ...
            if results.pose_landmarks:
                ...
                # การทำงานสำหรับ count reps หรือ time ตามแต่ละ activity
    ...
    with mp_pose.Pose(min_detection_confidence=0.7, min_tracking_confidence=0.7) as pose:
        while cap.isOpened():
            ...
            try:
                ...
                color = (0, 0, 255)
                if 160 < angle_left < 175 or 185 < angle_left < 200:
                    color = (0, 255, 0)
                ...
                cv2.putText(image, f"FPS: {fps}", (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
                cv2.putText(image, f"Angle: {int(angle_left)}", (10, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
